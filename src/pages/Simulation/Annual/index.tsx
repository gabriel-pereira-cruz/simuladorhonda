...
const TRIM = [
  // Ano KI começa em abril e termina em março.
  ...
  return (
    ...
    >
      <ScenarioSummary
        ...
        secundarios={[
          { label: "Plano anual simulado", value: `${(totals.reduce((a, b) => a + b.plano, 0) / 1000).toFixed(1)}k`, hint: "motos (unidades de produção) planejadas" },
                ...
                return (
                  ...
                  >
                    ...
                    {p.meses.map((v, m) => {
                      ...
                      const tip = `Plano ${v.toLocaleString("pt-BR")} motos · Atendido ${att.toLocaleString("pt-BR")} · ${pctVsPlano}% do plano do mês · ${pctVsPeak}% do pico anual`;
                      return (
                        <td
                          key={m}
                          title={tip}
