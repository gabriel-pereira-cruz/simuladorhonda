...
import { cadastrosNav, relatoriosNav, simulacoesNav, type NavLeaf } from "@/lib/navigation";
import { statusColor } from "@/lib/mockData";
import { getMergedSimulacoes, pathForSimulacaoTipo, subscribeSimulacoesChanged } from "@/lib/simulationHistory";
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] font-mono text-muted-foreground">{s.id}</p>
                    </div>
